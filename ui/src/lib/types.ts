...
export interface QuestionsView { relpath: string; sha256: string; stage: string; unit: string | null; questions: Question[]; summary_confirmation: Checkpoint | null; plan_approval: Checkpoint | null; pending_count: number; pending_checkpoint: 'summary_confirmation' | 'plan_approval' | null; mode: 'degraded' | 'structured'; host_card: HostQuestionCard | null; origin?: AuditQuestionOrigin }
